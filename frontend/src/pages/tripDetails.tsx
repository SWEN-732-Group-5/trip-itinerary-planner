...
function TripDetails() {
    ...
    const onSubmit = async (values: CreateTripEventInput) => {
        try {
            if (editingEventId) {
            ...
            <Card>
                ...
                <CardContent className="space-y-3">
                    <div>
                        ...
                        {organizers.length === 0 ? <p className="text-sm text-muted-foreground">None</p> :
                    ...
                    <div>
                        ...
                        {guests.length === 0 ? <p className="text-sm text-muted-foreground">None</p> :
